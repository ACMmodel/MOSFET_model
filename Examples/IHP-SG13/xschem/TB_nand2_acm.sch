...
N 535 -640 585 -640 {
lab=Y}
C {symbol/nand2_acm.sym} 475 -640 0 0 {name=x1 m=1 VDDPIN=VDD VSSPIN=VSS}
...
.endc
"}
C {devices/vsource.sym} 245 -630 0 1 {name=VA value="pulse(0 3.3 50n 200p 200p 50n 100n)"}
...
C {devices/lab_wire.sym} 585 -640 0 1 {name=p5 sig_type=std_logic lab=Y}
